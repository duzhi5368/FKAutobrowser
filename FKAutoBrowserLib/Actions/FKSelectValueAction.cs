...
namespace FKAutoBrowser
{
    ...
    /// </summary>
    class FKSelectValueAction : FKBaseAction
    {
        public string Value;


        public FKSelectValueAction(object value)
        {
        ...
        /// </summary>
        public FKSelectValueAction(string selector, object value)
        {
            Selector = selector;
            Value = value == null ? string.Empty : value.ToString();
        }
            ...
            try
            {
                ...
                foreach (IFKWebElement element in elements)
                {
                    ...
                    else
                    {
                        try
                        {
                            if (element.SelectByValue(Value))
                            {
                                succeededElements++;
                            }
                            else
