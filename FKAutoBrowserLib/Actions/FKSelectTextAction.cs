...
namespace FKAutoBrowser
{
    ...
    /// </summary>
    class FKSelectTextAction : FKBaseAction
    {
        public string Text;

        public FKSelectTextAction(object text)
        {
        ...
        /// </summary>
        public FKSelectTextAction(string selector, object text)
        {
            Selector = selector;
            Text = text == null ? string.Empty : text.ToString();
        }
